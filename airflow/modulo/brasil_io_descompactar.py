...
def descompactar_arquivo_gz(arquivo_gz, arquivo_destino):
    ...
    try:
        ...
        logger.info(f"Operação concluída. Descompacta o arquivo_gz para o arquivo_destino.")
...
def ingestao_dados_API():
    ...
    try:
        ...
        file_name = f"{dataset_slug}_{table_name}.csv.gz"
        ...
        logger.info(f"Operação concluída. Arquivo descompactado para 'cota-parlamentar.csv'.")
    except Exception as e:
